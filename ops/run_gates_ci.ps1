...
Invoke-GateScript -Path 'ops/check_include_tree.ps1'
Invoke-GateScript -Path 'ops/ha_structure_check.ps1' -Args @('-CheckEntityMap')
Invoke-GateScript -Path 'ops/check_vmc_dashboards.ps1'
Invoke-GateScript -Path 'ops/check_docs.ps1'
